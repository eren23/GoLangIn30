...
func main() {
    ...
    err = os.MkdirAll("subdir/parent/child", 0755)//We can create a hierarchy of directories, including parents with MkdirAll. This is similar to the command-line mkdir -p.
    check(err)
...
func visit(p string, info os.FileInfo, err error) error {
    if err != nil {//visit is called for every file or directory found recursively by filepath.Walk.
        return err
    }
